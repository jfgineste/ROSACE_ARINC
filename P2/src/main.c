...
int P2Main(void) {
  ...
  CREATE_SAMPLING_PORT("WHF", PORT_SIZE, SOURCE, 0.02 * SECOND,  &WHF,  &ret);
  CREATE_SAMPLING_PORT("WAZF", PORT_SIZE, SOURCE, 0.02 * SECOND,  &WAZF,  &ret);
  CREATE_SAMPLING_PORT("WVZF", PORT_SIZE, SOURCE, 0.02 * SECOND,  &WVZF,  &ret);
  CREATE_SAMPLING_PORT("WQF", PORT_SIZE, SOURCE, 0.02 * SECOND,  &WQF,  &ret);
  CREATE_SAMPLING_PORT("WVAF", PORT_SIZE, SOURCE, 0.02 * SECOND,  &WVAF,  &ret);

  printf("[P2] Bilan create output ports: HF=%d AZF=%d RVF=%d QF=%d VAF=%d\n", (int) WHF, (int) WAZF, (int) WVZF, (int) WQF, (int) WVAF);

  CREATE_SAMPLING_PORT("RH", PORT_SIZE, DESTINATION, 0.02 * SECOND,  &RH,  &ret);
  CREATE_SAMPLING_PORT("RAZ", PORT_SIZE, DESTINATION, 0.02 * SECOND,  &RAZ,  &ret);
  CREATE_SAMPLING_PORT("RVZ", PORT_SIZE, DESTINATION, 0.02 * SECOND,  &RVZ,  &ret);
  CREATE_SAMPLING_PORT("RQ", PORT_SIZE, DESTINATION, 0.02 * SECOND,  &RQ,  &ret);
  CREATE_SAMPLING_PORT("RVA", PORT_SIZE, DESTINATION, 0.02 * SECOND,  &RVA,  &ret);
